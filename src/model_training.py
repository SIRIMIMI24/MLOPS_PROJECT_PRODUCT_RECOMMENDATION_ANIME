...
class ModelTraining:
    def __init__(self,data_path):
        ...
        self.experiment = comet_ml.Experiment(
            api_key="x5sXApbFkZxV9JVucnW8X8U5o",
            project_name="MLOS-PRODUCT-RECOMMENDATION-ANIME",
            workspace="sirimimi24"
        )
        ...
        try:
            ...
            try:
                history = model.fit(
                        ...
                        epochs=1, # Set to 20 for better performance, you can adjust this based on your needs
                        verbose=1,
